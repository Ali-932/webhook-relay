...
// .wrangler/tmp/bundle-70X734/checked-fetch.js
...
// .wrangler/tmp/bundle-70X734/strip-cf-connecting-ip-header.js
    ...
    if (request.method === "POST" && path.startsWith("/webhook/")) {
      ...
      await env.DB.prepare(
        `INSERT INTO webhooks (id, token, method, headers, body, received_at)
         VALUES (?, ?, ?, ?, ?, ?)`
      ).bind(id, token, request.method, headers, body, received_at).run();
...
// .wrangler/tmp/bundle-70X734/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-70X734/middleware-loader.entry.ts
